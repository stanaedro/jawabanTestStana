...
<body>
    ...
    <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <input type="text" class="form-control" placeholder="Contoh : Dimas Saputra 27 Bandung." id="inputan">
                <br>
    ...
    <script>
        function insert() {
            let get_input = document.getElementById("inputan").value;
            var str = get_input;
            var res = str.split(" ");
            var tahun = res[2].replace("th", "").replace("tahun", "").replace('TH', "").replace('Tahun', "");
            document.getElementById("nama").innerHTML = res[0] + " " + res[1];
            document.getElementById("usia").innerHTML = tahun;
            document.getElementById("kota").innerHTML = res[3];
        }
    </script>
    <!-- Footer
        -->
